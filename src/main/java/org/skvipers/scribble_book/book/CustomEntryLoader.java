...
public class CustomEntryLoader extends SimpleJsonResourceReloadListener<BookEntry> {

    public static final CustomEntryLoader INSTANCE = new CustomEntryLoader();
    private static final Logger LOGGER = LogUtils.getLogger();

    private Map<Identifier, BookEntry> entries = Map.of();

    private CustomEntryLoader() {
        super(BookEntry.CODEC, FileToIdConverter.json("scribble_book/custom"));
    }
    ...
    protected void apply(Map<Identifier, BookEntry> objects, ResourceManager manager, ProfilerFiller profiler) {
        ...
        LOGGER.info("Loaded {} scribble book custom entries", entries.size());
    }
