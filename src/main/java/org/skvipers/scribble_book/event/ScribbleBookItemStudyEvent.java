...
/**
 * Fired on NeoForge.EVENT_BUS before a player studies a dropped item with the Scribble Book.
 *
 * <p>Listeners may:
 * <ul>
 ...
 * </ul>
 */
public class ScribbleBookItemStudyEvent extends Event implements ICancellableEvent {
    ...
    public ScribbleBookItemStudyEvent(Player player, ItemEntity itemEntity,
